...
def main():
    ...
    hub_dict['opt_kwargs']['options']['init_W_fname'] = 'w_file.csv'
    hub_dict['opt_kwargs']['options']['init_Xbar_fname'] = 'xbar_file.csv'

    hub_dict['opt_kwargs']['options']["W_and_xbar_writer"] =  {"Wcsvdir": "Wdir"}
    hub_dict['opt_kwargs']['options']['W_fname'] = 'warm_start_w.csv'
    hub_dict['opt_kwargs']['options']['Xbar_fname'] = 'warm_start_xbar.csv'
